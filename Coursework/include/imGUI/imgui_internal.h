...
template<typename BufferType> static inline BufferType ImMin(BufferType lhs, BufferType rhs)                        { return lhs < rhs ? lhs : rhs; }
template<typename BufferType> static inline BufferType ImMax(BufferType lhs, BufferType rhs)                        { return lhs >= rhs ? lhs : rhs; }
template<typename BufferType> static inline BufferType ImClamp(BufferType v, BufferType mn, BufferType mx)                   { return (v < mn) ? mn : (v > mx) ? mx : v; }
template<typename BufferType> static inline BufferType ImLerp(BufferType a, BufferType b, float t)                  { return (BufferType)(a + (b - a) * t); }
template<typename BufferType> static inline void ImSwap(BufferType& a, BufferType& b)                      { BufferType tmp = a; a = b; b = tmp; }
// - Misc maths helpers
